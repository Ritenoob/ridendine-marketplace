...
export const ORDER_TRANSITIONS: StateTransition<EngineOrderStatus, OrderAction>[] = [
  ...
  // === CHEF ACCEPTANCE/REJECTION ===
  {
    ...
    action: 'accept_order',
    allowedActors: [ActorRole.CHEF_USER, ActorRole.CHEF_MANAGER, ActorRole.OPS_AGENT, ActorRole.OPS_ADMIN, ActorRole.OPS_MANAGER, ActorRole.SUPER_ADMIN],
  ...
  },
  {
    ...
    action: 'mark_ready',
    allowedActors: [ActorRole.CHEF_USER, ActorRole.CHEF_MANAGER, ActorRole.OPS_AGENT, ActorRole.OPS_ADMIN, ActorRole.OPS_MANAGER],
  ...
  // === DISPATCH ===
  {
    ...
    allowedActors: [ActorRole.SYSTEM, ActorRole.OPS_AGENT, ActorRole.OPS_ADMIN, ActorRole.OPS_MANAGER],
  ...
  },
  {
    ...
    action: 'cancel_order',
    allowedActors: [ActorRole.CUSTOMER, ActorRole.CHEF_USER, ActorRole.CHEF_MANAGER, ActorRole.OPS_AGENT, ActorRole.OPS_ADMIN, ActorRole.OPS_MANAGER, ActorRole.SUPER_ADMIN],
  ...
  // === REFUNDS ===
  {
    ...
    allowedActors: [ActorRole.CUSTOMER, ActorRole.OPS_AGENT, ActorRole.OPS_ADMIN, ActorRole.OPS_MANAGER, ActorRole.SUPER_ADMIN],
  ...
  },
  {
    ...
    allowedActors: [ActorRole.OPS_AGENT, ActorRole.OPS_ADMIN, ActorRole.OPS_MANAGER, ActorRole.FINANCE_ADMIN, ActorRole.FINANCE_MANAGER, ActorRole.SUPER_ADMIN],
  ...
  },
  {
    ...
    allowedActors: [ActorRole.SYSTEM, ActorRole.OPS_AGENT, ActorRole.OPS_ADMIN, ActorRole.OPS_MANAGER, ActorRole.SUPER_ADMIN],
  ...
  // === OPS OVERRIDE (can force any transition) ===
  {
    ...
    to: EngineOrderStatus.COMPLETED,
    action: 'ops_override',
    allowedActors: [ActorRole.OPS_ADMIN, ActorRole.OPS_MANAGER, ActorRole.SUPER_ADMIN],
