...
- Page routes: 23 total, 14 WIRED, 9 PARTIAL, 0 MISSING.
- API route files: 31 total, 26 WIRED, 5 PARTIAL.
...
| PARTIAL | `/account/addresses` | [apps/web/src/app/account/addresses/page.tsx](../../../apps/web/src/app/account/addresses/page.tsx) | [apps/web/src/app/account/layout.tsx](../../../apps/web/src/app/account/layout.tsx) | Undetected | None detected | `/api/addresses`, `/api/addresses?id=${id}` | `@/components/layout/header`, `Button`, `Card`, `Input`, `Select` |
...
| PARTIAL | `/account/settings` | [apps/web/src/app/account/settings/page.tsx](../../../apps/web/src/app/account/settings/page.tsx) | [apps/web/src/app/account/layout.tsx](../../../apps/web/src/app/account/layout.tsx) | Undetected | None detected | `/api/profile` | `@/components/layout/header`, `Button`, `Card`, `Input` |
...
| PARTIAL | `/contact` | [apps/web/src/app/contact/page.tsx](../../../apps/web/src/app/contact/page.tsx) | [apps/web/src/app/layout.tsx](../../../apps/web/src/app/layout.tsx) | Undetected | None detected | `/api/support` | `@/components/layout/header`, `Button`, `Card`, `Input`, `Textarea` |
...
| PARTIAL | `/api/storefronts/:id/menu` | GET | [apps/web/src/app/api/storefronts/[id]/menu/route.ts](../../../apps/web/src/app/api/storefronts/[id]/menu/route.ts) | Undetected | `chef_storefronts`, `menu_item_options`, `menu_items` | @ridendine/db | None detected |
| PARTIAL | `/api/storefronts/:id` | GET | [apps/web/src/app/api/storefronts/[id]/route.ts](../../../apps/web/src/app/api/storefronts/[id]/route.ts) | Undetected | `chef_storefronts` | @ridendine/db | None detected |
| PARTIAL | `/api/storefronts` | GET | [apps/web/src/app/api/storefronts/route.ts](../../../apps/web/src/app/api/storefronts/route.ts) | Undetected | None detected | @ridendine/db | None detected |
