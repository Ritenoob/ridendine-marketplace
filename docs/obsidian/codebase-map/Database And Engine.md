...
- [supabase/migrations/00022_bank_payout_rail.sql](../../../supabase/migrations/00022_bank_payout_rail.sql)
- [supabase/migrations/00023_ops_processor_runs.sql](../../../supabase/migrations/00023_ops_processor_runs.sql)
- [supabase/migrations/00024_canonical_consolidation.sql](../../../supabase/migrations/00024_canonical_consolidation.sql)
- [supabase/migrations/00025_rls_role_alignment.sql](../../../supabase/migrations/00025_rls_role_alignment.sql)
...
| --- | --- | --- |
| [packages/auth/src/components/auth-provider.tsx](../../../packages/auth/src/components/auth-provider.tsx) | None detected | @ridendine/db |
...
| [packages/engine/src/core/sms-provider.test.ts](../../../packages/engine/src/core/sms-provider.test.ts) | None detected | None detected |
| [packages/engine/src/core/sms-provider.ts](../../../packages/engine/src/core/sms-provider.ts) | `${accountSid}:${authToken}` | @ridendine/types |
| [packages/engine/src/core/sms-templates.ts](../../../packages/engine/src/core/sms-templates.ts) | None detected | @ridendine/types |
...
| [packages/engine/src/orchestrators/delivery-engine.ts](../../../packages/engine/src/orchestrators/delivery-engine.ts) | `deliveries`, `delivery_events`, `driver_presence`, `drivers`, `orders` | @ridendine/routing, @ridendine/types |
...
| [packages/engine/src/orchestrators/dispatch-orchestrator.test.ts](../../../packages/engine/src/orchestrators/dispatch-orchestrator.test.ts) | None detected | None detected |
...
| [packages/engine/src/orchestrators/master-order-engine.ts](../../../packages/engine/src/orchestrators/master-order-engine.ts) | `deliveries`, `ledger_entries`, `order_exceptions`, `order_status_history`, `orders` | @ridendine/types |
| [packages/engine/src/orchestrators/offer-management.service.test.ts](../../../packages/engine/src/orchestrators/offer-management.service.test.ts) | None detected | None detected |
| [packages/engine/src/orchestrators/offer-management.service.ts](../../../packages/engine/src/orchestrators/offer-management.service.ts) | `assignment_attempts`, `deliveries`, `delivery_events`, `driver_presence`, `drivers`, `notifications`, `order_exceptions`, `orders`, `service_areas`, `system_alerts` | @ridendine/db, @ridendine/routing, @ridendine/types |
| [packages/engine/src/orchestrators/operations-command.gateway.test.ts](../../../packages/engine/src/orchestrators/operations-command.gateway.test.ts) | None detected | @ridendine/types |
| [packages/engine/src/orchestrators/operations-command.gateway.ts](../../../packages/engine/src/orchestrators/operations-command.gateway.ts) | `chef_storefronts`, `platform_settings`, `system_alerts` | @ridendine/types, @ridendine/validation |
...
| [packages/engine/src/services/delivery-fee.service.test.ts](../../../packages/engine/src/services/delivery-fee.service.test.ts) | None detected | None detected |
| [packages/engine/src/services/delivery-fee.service.ts](../../../packages/engine/src/services/delivery-fee.service.ts) | None detected | None detected |
...
| [packages/engine/src/services/geocoding.service.test.ts](../../../packages/engine/src/services/geocoding.service.test.ts) | None detected | None detected |
| [packages/engine/src/services/geocoding.service.ts](../../../packages/engine/src/services/geocoding.service.ts) | None detected | None detected |
...
| [packages/engine/src/services/loyalty.service.test.ts](../../../packages/engine/src/services/loyalty.service.test.ts) | None detected | None detected |
| [packages/engine/src/services/loyalty.service.ts](../../../packages/engine/src/services/loyalty.service.ts) | `loyalty_accounts`, `loyalty_transactions` | None detected |
...
| [packages/engine/src/services/referral.service.test.ts](../../../packages/engine/src/services/referral.service.test.ts) | None detected | None detected |
| [packages/engine/src/services/referral.service.ts](../../../packages/engine/src/services/referral.service.ts) | `promo_codes`, `referral_codes`, `referral_signups` | @ridendine/db |
...
| [packages/engine/src/services/surge-pricing.service.test.ts](../../../packages/engine/src/services/surge-pricing.service.test.ts) | None detected | None detected |
| [packages/engine/src/services/surge-pricing.service.ts](../../../packages/engine/src/services/surge-pricing.service.ts) | `service_areas` | None detected |
| [packages/engine/src/services/tax-config.service.test.ts](../../../packages/engine/src/services/tax-config.service.test.ts) | None detected | None detected |
| [packages/engine/src/services/tax-config.service.ts](../../../packages/engine/src/services/tax-config.service.ts) | `platform_settings` | None detected |
| [packages/engine/src/types/payment-adapter.ts](../../../packages/engine/src/types/payment-adapter.ts) | None detected | None detected |
