...
- API route files detected: 123
- Internal/external link and fetch references detected: 270
- Broken static internal references: 0
- Unknown dynamic references: 2
- Supabase migration files scanned: 44
- Data/engine/package source files scanned: 259
- Table/RPC identifiers detected: 136
