...
- App pages detected: 90
- API route files detected: 118
- Internal/external link and fetch references detected: 267
- Broken static internal references: 0
- Unknown dynamic references: 2
- Supabase migration files scanned: 43
- Data/engine/package source files scanned: 255
- Table/RPC identifiers detected: 135
