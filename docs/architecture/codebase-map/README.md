...
- App pages detected: 88
- API route files detected: 104
- Internal/external link and fetch references detected: 258
- Broken static internal references: 0
- Unknown dynamic references: 1
- Supabase migration files scanned: 29
- Data/engine/package source files scanned: 248
- Table/RPC identifiers detected: 133
