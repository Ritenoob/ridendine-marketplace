...
| WIRED | `/dashboard/reviews` | [apps/chef-admin/src/app/dashboard/reviews/page.tsx](../../../../apps/chef-admin/src/app/dashboard/reviews/page.tsx) | [apps/chef-admin/src/app/dashboard/layout.tsx](../../../../apps/chef-admin/src/app/dashboard/layout.tsx) | Chef protected | `chef_profiles`, `chef_storefronts`, `reviews` | None detected | `Badge`, `Button`, `Card` |
...
| WIRED | `/api/storefront` | GET, PATCH, POST | [apps/chef-admin/src/app/api/storefront/route.ts](../../../../apps/chef-admin/src/app/api/storefront/route.ts) | Chef protected | `chef_kitchens`, `chef_storefronts` | @ridendine/db | Supabase |
