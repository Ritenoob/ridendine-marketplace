...
- Internal link/API references: 46 total, 0 BROKEN, 0 UNKNOWN_DYNAMIC.
...
| WIRED | `/earnings` | [apps/driver-app/src/app/earnings/page.tsx](../../../../apps/driver-app/src/app/earnings/page.tsx) | [apps/driver-app/src/app/layout.tsx](../../../../apps/driver-app/src/app/layout.tsx) | Detected | `driver_payout_accounts`, `instant_payout_requests`, `platform_accounts` | None detected | None detected |
...
| WIRED | `/api/driver/notification-preferences` | GET, PATCH | [apps/driver-app/src/app/api/driver/notification-preferences/route.ts](../../../../apps/driver-app/src/app/api/driver/notification-preferences/route.ts) | Detected | `driver_notification_preferences` | @ridendine/db, @ridendine/validation | None detected |
...
| WIRED | `/api/driver/readiness` | GET | [apps/driver-app/src/app/api/driver/readiness/route.ts](../../../../apps/driver-app/src/app/api/driver/readiness/route.ts) | Detected | `deliveries`, `driver_documents`, `driver_payout_accounts`, `driver_presence`, `drivers`, `platform_accounts` | @ridendine/db, @ridendine/types | None detected |
...
| WIRED | `/api/driver/shift` | GET | [apps/driver-app/src/app/api/driver/shift/route.ts](../../../../apps/driver-app/src/app/api/driver/shift/route.ts) | Detected | `deliveries`, `driver_presence`, `driver_shifts` | @ridendine/db, @ridendine/types | Supabase |
| WIRED | `/api/earnings` | GET | [apps/driver-app/src/app/api/earnings/route.ts](../../../../apps/driver-app/src/app/api/earnings/route.ts) | Detected | `driver_payout_accounts`, `instant_payout_requests`, `platform_accounts` | @ridendine/db | Supabase |
