...
| [apps/chef-admin/src/app/auth/login/page.tsx](../../apps/chef-admin/src/app/auth/login/page.tsx) | Public auth | Public chef login surface wired to app-owned login API | `/api/auth/login` | None | WIRED |  |
