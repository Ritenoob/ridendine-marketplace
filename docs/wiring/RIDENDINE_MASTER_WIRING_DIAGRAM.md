...
Detected page routes: 90. Customer Web: 23, Ops Admin: 40, Chef Admin: 17, Driver App: 10.
...
Detected API route files: 123. Customer Web: 31, Ops Admin: 54, Chef Admin: 19, Driver App: 19.
