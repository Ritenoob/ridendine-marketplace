        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Card className="border-border bg-surface p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex justify-between gap-4">
                <span className="text-textMuted">Chef / Storefront</span>
              ...
              <div className="flex justify-between gap-4">
                <span className="text-textMuted">Estimated Ready</span>
                <span className="text-white">
                  {formatTimestamp(order.estimated_ready_at)}
                </span>
              </div>
              <div className="flex justify-between gap-4">
                <span className="text-textMuted">Actual Ready</span>
                <span className="text-white">
          ...
          <Card className="border-border bg-surface p-6">
            ...
            {order.customer ? (
              <div className="space-y-3 text-sm">
                ...
                <div className="pt-2">
                  <p className="text-textMuted">Delivery Address</p>
              ...
              <p className="text-textMuted">Customer information not available.</p>
            )}
            ...
            <div className="mt-6 rounded-lg border border-border bg-surface p-4">
              ...
              <div className="mt-3 space-y-2 text-sm">
                ...
                <div className="flex justify-between gap-4">
                  <span className="text-textMuted">Assigned Driver</span>
                  <span className="text-white">
          ...
          <table className="w-full">
            ...
            <tbody>
              {order.items.length > 0 ? (
                ...
                <tr>
                  <td colSpan={4} className="py-3 text-center text-textMuted">
                    No items found
                  </td>
                </tr>
              )}
          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-2">
            <div className="space-y-2 pt-4 text-sm">
              ...
              <div className="flex justify-between border-t border-border pt-2 text-lg font-bold">
                ...
                <span className="text-success">{formatMoney(order.total)}</span>
              </div>
            </div>
                ...
                {timeline.slice(0, 8).map((entry: { id?: string; eventType?: string; createdAt?: string; metadata?: Record<string, unknown> | null }) => (
                  <div key={entry.id ?? `${entry.eventType}-${entry.createdAt}`} className="flex gap-3">
                    ...
                    <div>
                      ...
                      {entry.metadata && (
                        <pre className="mt-2 overflow-x-auto rounded bg-surface p-2 text-xs text-textSubtle">
